...
const EditProfileScreen = ({navigation}) => {
    ...
    const renderContent = ()=> (
        <View style={styles.panel}>
            ...
            <TouchableOpacity style={styles.panelClose} onPress={()=> bs.current.snapTo(1)}>
        ...
        <SafeAreaView style={styles.container}>
            ...
            <Animated.View style={{flex: 1,
                ...
                <View style={{alignItems: "center", top: 12, paddingBottom: 10, marginBottom: 15}}>
                    <Text style={{fontSize: 30, color: "#FFF", fontWeight: "bold"}}>Edit User Account</Text>
                </View>
                    ...
                    <KeyboardAvoidingView behavior={'position'} contentContainerStyle={styles.body} keyboardVerticalOffset={90}>
                        ...
                        <TouchableOpacity onPress={()=> navigation.goBack()} activeOpacity={0.5}>
                            <View style={styles.buttonOutline}>
                                <Text style={{color: "#42C294", fontSize: 20, fontWeight: "bold"}}>Kembali</Text>
                            </View>
                        </TouchableOpacity>
                    </>
